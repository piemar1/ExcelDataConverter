...
class Write_output_PnVa_Units_paternA():
...
class Write_output_CEGLY_paternA():
    ...
    def __init__(self):
        ...
        # self.output_lista_cegiel = None
        # self.daty = None
        # self.output_leki_cegly = None
        # self.CEGLY_data = None
    ...
    def start_output(self, output_lista_cegiel):
        ...
        for elem in range(len(self.output_lista_cegiel)):
            self.output_file.create_sheet(self.output_lista_cegiel[elem], elem)
    ...
    def write_base_data(self, output_lista_cegiel, output_leki_cegly, daty):
        ...
        self.output_lista_cegiel = output_lista_cegiel
        self.output_leki_cegly = output_leki_cegly
        self.daty = daty
