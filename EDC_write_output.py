...
class Write_output_PnVa_Units_paternA(ReadInput):
    ...
    def __init__(self, rodzaj_danych):
        ReadInput.__init__(self, input_file_path1)
...
class Write_output_CEGLY_paternA(ReadInput):
...
if __name__ == '__main__':
    ...
    input1 = ReadInput(input_file_path1)
